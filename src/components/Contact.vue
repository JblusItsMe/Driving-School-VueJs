<template>
    <div class="isolate bg-white px-6 py-24 sm:py-32 lg:px-8" id="go-contact">
        ...
        <div class="mx-auto max-w-2xl text-center">
            ...
            <p class="mt-2 text-lg leading-8 text-gray-600">Do you have questions about your driver's license? Do you want additional information about our driving school? Do not hesitate to let us know, we will answer you as soon as possible.</p>
        </div>
        <form action="#" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
            ...
            <div class="mt-10">
                <button type="submit" style="background: #44B272" class="block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Let's talk</button>
            </div>
        </form>
    </div>
</template>
